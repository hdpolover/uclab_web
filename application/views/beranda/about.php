					...
					<div class="row col-mb-80 mb-0">
						...
						<div class="col-12">
							...
							<div class="heading-block center border-bottom-0">
								...
								<span>We value Work Ethics &amp; Environment as it helps in creating a Creative
									Thinktank</span>
							</div>
							...
							<div class="fslider" data-pagi="false" data-animation="fade">
								<div class="flexslider">
									<div class="slider-wrap">
										<div class="slide"><a href="#"><img src="<?= base_url(); ?>assets/images/about/4.jpg" alt="About Image"></a>
										</div>
										<div class="slide"><a href="#"><img src="<?= base_url(); ?>assets/images/about/5.jpg" alt="About Image"></a>
										</div>
										<div class="slide"><a href="#"><img src="<?= base_url(); ?>assets/images/about/6.jpg" alt="About Image"></a>
										</div>
										<div class="slide"><a href="#"><img src="<?= base_url(); ?>assets/images/about/7.jpg" alt="About Image"></a>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="promo promo-light p-4 p-md-5 mb-5">
						<div class="row align-items-center">
							<div class="col-12 col-lg">
								...
								<span>Starts at just <em>$9.99/month</em> afterwards. No Ads, No Gimmicks and No SPAM. Just
									Real Content.</span>
							</div>
							...
							<div class="team team-list row align-items-center">
								...
								<div class="team-desc col-sm-6">
									...
									<div class="team-content">
										<p>Carbon emissions reductions giving, legitimize amplify non-partisan Aga Khan.
											Policy dialogue assessment expert free-speech cornerstone disruptor freedom. Cesar
											Chavez empower.</p>
									</div>
							...
							<div class="slider-wrap">
								<div class="slide">
									<div class="testi-image">
										<a href="#"><img src="<?= base_url(); ?>assets/images/testimonials/3.jpg" alt="Customer Testimonails"></a>
									</div>
								...
								<div class="slide">
									<div class="testi-image">
										<a href="#"><img src="<?= base_url(); ?>assets/images/testimonials/2.jpg" alt="Customer Testimonails"></a>
									</div>
									<div class="testi-content">
								...
								<div class="slide">
									<div class="testi-image">
										<a href="#"><img src="<?= base_url(); ?>assets/images/testimonials/1.jpg" alt="Customer Testimonails"></a>
									</div>
									<div class="testi-content">
